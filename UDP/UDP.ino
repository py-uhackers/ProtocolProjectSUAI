...
void handleUDPClient()
{
  ...
  if (packetSize)
  {
    ...
    time_t currentTime = now();  // Use the now() function from the Time library
...
void setup()
{
  ...
  // Set up the Time library
  configTime(3 * 3600, 0, "pool.ntp.org");  // Set your time zone and NTP server
